...
from repository_scanner_backend.db.model import DBbranchInfo, DBfinding, DBrepositoryInfo, DBrule, DBscan, DBscanFinding
...
def check_db_initialized():
    required_table_names = [
        DBbranchInfo.__tablename__,
        DBfinding.__tablename__,
        DBrepositoryInfo.__tablename__,
