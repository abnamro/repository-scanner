...
# First Party
from repository_scanner_backend.constants import PROJECT_QUEUE, REPOSITORY_QUEUE
...
with mock.patch.dict(os.environ, {"RESC_RABBITMQ_SERVICE_HOST": RESC_RABBITMQ_SERVICE_HOST,
    ...
    # First Party
    from repository_scanner_backend.helpers.rabbitmq import \
        rabbitmq_initialization as rabbitmq_init  # noqa: E402  # isort:skip
...
@patch("repository_scanner_backend.helpers.rabbitmq.rabbitmq_initialization.set_topic_permissions")
@patch("repository_scanner_backend.helpers.rabbitmq.rabbitmq_initialization.set_resource_permissions")
@patch("repository_scanner_backend.helpers.rabbitmq.rabbitmq_initialization.create_user")
