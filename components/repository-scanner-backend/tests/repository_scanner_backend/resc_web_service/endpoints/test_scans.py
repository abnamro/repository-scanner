...
from repository_scanner_backend.db.model import DBfinding, DBrule, DBscan
...
class TestScans(unittest.TestCase):
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.scan.get_scan")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.scan.get_scan")
    @patch("repository_scanner_backend.resc_web_service.crud.scan.delete_scan")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.scan.create_scan")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.scan.get_scan")
    @patch("repository_scanner_backend.resc_web_service.crud.scan.update_scan")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_scans_findings")
