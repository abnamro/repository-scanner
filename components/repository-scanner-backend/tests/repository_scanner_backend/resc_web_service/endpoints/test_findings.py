...
from repository_scanner_backend.db.model import DBfinding, DBscanFinding
...
from repository_scanner_backend.resc_web_service.schema.audit import AuditMultiple, AuditSingle
from repository_scanner_backend.resc_web_service.schema.date_filter import DateFilter
from repository_scanner_backend.resc_web_service.schema.finding import Finding, FindingBase, FindingCreate, FindingRead
...
class TestFindings(unittest.TestCase):
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_finding")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_finding")
    @patch("repository_scanner_backend.resc_web_service.crud.scan_finding.delete_scan_finding")
    @patch("repository_scanner_backend.resc_web_service.crud.finding.delete_finding")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.create_findings")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_finding")
    @patch("repository_scanner_backend.resc_web_service.crud.scan_finding.get_scan_findings")
    @patch("repository_scanner_backend.resc_web_service.crud.finding.update_finding")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_finding")
    @patch("repository_scanner_backend.resc_web_service.crud.scan_finding.get_scan_findings")
    @patch("repository_scanner_backend.resc_web_service.crud.finding.patch_finding")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_findings")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_total_findings_count")
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_findings_by_rule")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_finding")
    @patch("repository_scanner_backend.resc_web_service.crud.scan_finding.get_scan_findings")
    @patch("repository_scanner_backend.resc_web_service.crud.finding.audit_finding")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_findings_count_by_time")
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_findings_count_by_time_total")
