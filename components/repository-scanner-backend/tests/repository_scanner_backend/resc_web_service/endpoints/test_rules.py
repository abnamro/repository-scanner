...
from repository_scanner_backend.db.model import DBrule
...
from repository_scanner_backend.resc_web_service.schema.rule import RuleCreate
from repository_scanner_backend.resc_web_service.schema.rule_allow_list import RuleAllowListCreate
from repository_scanner_backend.resc_web_service.schema.rule_pack import RulePackCreate
...
class TestRules(unittest.TestCase):
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_distinct_rules_from_findings")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_findings_count_by_status")
    @patch("repository_scanner_backend.resc_web_service.crud.finding.get_distinct_rules_from_findings")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.rule.create_rule_allow_list")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.rule.create_rule_pack_version")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.rule.create_rule")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.rule.get_rule_pack")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.rule.get_rule_packs_count")
    @patch("repository_scanner_backend.resc_web_service.crud.rule.get_all_rule_packs")
