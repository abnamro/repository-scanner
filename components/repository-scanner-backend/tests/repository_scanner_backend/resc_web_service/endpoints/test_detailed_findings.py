...
# First Party
from repository_scanner_backend.constants import RWS_ROUTE_DETAILED_FINDINGS, RWS_VERSION_PREFIX
...
from repository_scanner_backend.resc_web_service.schema.detailed_finding import DetailedFindingRead
...
class TestDetailedFindings(unittest.TestCase):
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.detailed_finding.get_detailed_finding")
    ...
    @patch("repository_scanner_backend.resc_web_service.crud.detailed_finding.get_detailed_findings")
