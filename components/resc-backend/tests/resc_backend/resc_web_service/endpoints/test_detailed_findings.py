...
# First Party
from resc_backend.constants import CACHE_PREFIX, REDIS_CACHE_EXPIRE, RWS_ROUTE_DETAILED_FINDINGS, RWS_VERSION_PREFIX
...
class TestDetailedFindings(unittest.TestCase):
    ...
    def test_get_multiple_findings(self, get_findings, get_findings_count):
        ...
        with self.client as client:
            response = client.get(f"{RWS_VERSION_PREFIX}{RWS_ROUTE_DETAILED_FINDINGS}",
            ...
            cached_response = client.get(f"{RWS_VERSION_PREFIX}{RWS_ROUTE_DETAILED_FINDINGS}",
                                         params={"skip": 0, "limit": 5})
