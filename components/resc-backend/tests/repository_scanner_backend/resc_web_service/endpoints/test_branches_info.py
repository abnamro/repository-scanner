...
# First Party
from resc_backend.constants import RWS_ROUTE_BRANCHES_INFO, RWS_ROUTE_LAST_SCAN, RWS_ROUTE_SCANS, RWS_VERSION_PREFIX
from resc_backend.db.model import DBbranchInfo, DBscan
...
from resc_backend.resc_web_service.schema.branch_info import BranchInfoCreate
...
class TestBranchesInfo(unittest.TestCase):
    ...
    @patch("resc_backend.resc_web_service.crud.branch_info.get_branch_info")
    ...
    @patch("resc_backend.resc_web_service.crud.branch_info.create_branch_info_if_not_exists")
    ...
    @patch("resc_backend.resc_web_service.crud.branch_info.create_branch_info_if_not_exists")
    @patch("resc_backend.resc_web_service.crud.branch_info.create_branch_info")
    ...
    @patch("resc_backend.resc_web_service.crud.branch_info.update_branch_info")
    @patch("resc_backend.resc_web_service.crud.branch_info.get_branch_info")
    ...
    @patch("resc_backend.resc_web_service.crud.branch_info.delete_branch_info")
    @patch("resc_backend.resc_web_service.crud.branch_info.get_branch_info")
    ...
    @patch("resc_backend.resc_web_service.crud.branch_info.get_branches_info_count")
    @patch("resc_backend.resc_web_service.crud.branch_info.get_branches_info")
    ...
    @patch("resc_backend.resc_web_service.crud.branch_info.get_findings_metadata_by_branch_info_id")
    @patch("resc_backend.resc_web_service.crud.branch_info.get_branch_info")
