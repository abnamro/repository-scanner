...
class TestScans(unittest.TestCase):
    ...
    @patch("resc_backend.resc_web_service.crud.scan.delete_branch_findings_not_linked_to_any_scan")
    def test_delete_scan(self, delete_branch_findings_not_linked_to_any_scan, delete_scan, get_scan):
        db_scan = self.db_scans[0]
        get_scan.return_value = db_scan
        ...
        delete_branch_findings_not_linked_to_any_scan.assert_called_once_with(ANY, branch_id=db_scan.id_)
