...
from resc_backend.db.model import DBbranchInfo, DBfinding, DBrepositoryInfo, DBscan, DBVcsInstance
...
from resc_backend.resc_web_service.schema.repository_info import RepositoryInfoCreate
...
class TestRepositoriesInfo(unittest.TestCase):
    ...
    @patch("resc_backend.resc_web_service.crud.repository_info.create_repository_info_if_not_exists")
    ...
    @patch("resc_backend.resc_web_service.crud.repository_info.get_repository_info")
    ...
    @patch("resc_backend.resc_web_service.crud.repository_info.get_repository_info")
    @patch("resc_backend.resc_web_service.crud.repository_info.update_repository_info")
    ...
    @patch("resc_backend.resc_web_service.crud.repository_info.get_repository_info")
    @patch("resc_backend.resc_web_service.crud.repository_info.delete_repository_info")
    ...
    @patch("resc_backend.resc_web_service.crud.repository_info.create_repository_info")
    ...
    @patch("resc_backend.resc_web_service.crud.repository_info.get_repositories_info_count")
    @patch("resc_backend.resc_web_service.crud.repository_info.get_repositories_info")
    ...
    @patch("resc_backend.resc_web_service.crud.branch_info.get_branches_info_for_repository")
    @patch("resc_backend.resc_web_service.crud.branch_info.get_branches_info_count_for_repository")
    ...
    @patch("resc_backend.resc_web_service.crud.repository_info.get_distinct_projects")
    ...
    @patch("resc_backend.resc_web_service.crud.repository_info.get_distinct_repositories")
    ...
    @patch("resc_backend.resc_web_service.crud.repository_info"
           ".get_findings_metadata_by_repository_info_id")
    @patch("resc_backend.resc_web_service.crud.repository_info.get_repository_info")
